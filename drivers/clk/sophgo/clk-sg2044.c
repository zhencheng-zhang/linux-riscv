...
static const struct sg2044_divider_clock div_clks[] = {
	{ DIV_CLK_MPLL0_AP_CPU_NORMAL_0, "clk_div_ap_cpu_normal_0", "clk_gate_ap_cpu_normal_div0",
	...
	{ DIV_CLK_MPLL3_CC_GRP_SYS_0, "clk_div_cc_grp_sys_0", "clk_gate_cc_grp_sys_div0",
	...
	{ DIV_CLK_MPLL5_SRC1_0, "clk_div_src1_0", "clk_gate_src1_div0",
		0, 0x207c, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_FPLL0_CC_GRP_SYS_1, "clk_div_cc_grp_sys_1", "clk_gate_cc_grp_sys_div1",
	...
	{ DIV_CLK_FPLL0_RP_SYS_1, "clk_div_rp_sys_1", "clk_gate_rp_sys_div1",
		0, 0x2050, 16, 11, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_FPLL0_AP_CPU_NORMAL_1, "clk_div_ap_cpu_normal_1", "clk_gate_ap_cpu_normal_div1",
	...
	{ DIV_CLK_FPLL0_CXP_MAC_1, "clk_div_cxp_mac_1", "clk_gate_cxp_mac_div1",
		0, 0x2088, 16, 11, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	...
	{ DIV_CLK_FPLL0_DIV_TMIER5, "clk_div_timer5", "clk_div_top_50m",
		0, 0x20e0, 16, 5, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	...
	{ DIV_CLK_FPLL0_DIV_TMIER7, "clk_div_timer7", "clk_div_top_50m",
		0, 0x20e8, 16, 5, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	...
	{ DIV_CLK_FPLL0_EMMC, "clk_div_emmc", "fpll0_clock",
		0, 0x2108, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_FPLL0_SD, "clk_div_sd", "fpll0_clock",
		0, 0x2110, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	...
	{ DIV_CLK_FPLL0_DIV_100K_SD, "clk_div_100k_sd", "clk_div_top_axi0",
		0, 0x2114, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_FPLL0_DIV_100K_EMMC, "clk_div_100k_emmc", "clk_div_top_axi0",
		0, 0x210c, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	...
	{ DIV_CLK_FPLL1_PCIE_1G, "clk_div_pcie_1g", "fpll1_clock",
		0, 0x2160, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_FPLL2_CXP_TEST_ETH_PHY, "clk_div_cxp_test_eth_phy", "fpll2_clock",
		0, 0x2064, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_DPLL0_DDR0_0, "clk_div_ddr0_0", "clk_gate_ddr0_div0",
		0, 0x2120, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_FPLL0_DDR0_1, "clk_div_ddr0_1", "clk_gate_ddr0_div1",
		0, 0x2124, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_DPLL1_DDR1_0, "clk_div_ddr1_0", "clk_gate_ddr1_div0",
		0, 0x2128, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_FPLL0_DDR1_1, "clk_div_ddr1_1", "clk_gate_ddr1_div1",
		0, 0x212c, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_DPLL2_DDR2_0, "clk_div_ddr2_0", "clk_gate_ddr2_div0",
		0, 0x2130, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_FPLL0_DDR2_1, "clk_div_ddr2_1", "clk_gate_ddr2_div1",
		0, 0x2134, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_DPLL3_DDR3_0, "clk_div_ddr3_0", "clk_gate_ddr3_div0",
		0, 0x2138, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_FPLL0_DDR3_1, "clk_div_ddr3_1", "clk_gate_ddr3_div1",
		0, 0x213c, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_DPLL4_DDR4_0, "clk_div_ddr4_0", "clk_gate_ddr4_div0",
		0, 0x2140, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_FPLL0_DDR4_1, "clk_div_ddr4_1", "clk_gate_ddr4_div1",
		0, 0x2144, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_DPLL5_DDR5_0, "clk_div_ddr5_0", "clk_gate_ddr5_div0",
		0, 0x2148, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_FPLL0_DDR5_1, "clk_div_ddr5_1", "clk_gate_ddr5_div1",
		0, 0x214c, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_DPLL6_DDR6_0, "clk_div_ddr6_0", "clk_gate_ddr6_div0",
		0, 0x2150, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_FPLL0_DDR6_1, "clk_div_ddr6_1", "clk_gate_ddr6_div1",
		0, 0x2154, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_DPLL7_DDR7_0, "clk_div_ddr7_0", "clk_gate_ddr7_div0",
		0, 0x2158, 16, 8, CLK_DIVIDER_ONE_BASED |
			CLK_DIVIDER_ALLOW_ZERO, SG2044_CLK_USE_REG_VAL, },
	{ DIV_CLK_FPLL0_DDR7_1, "clk_div_ddr7_1", "clk_gate_ddr7_div1",
...
static const struct sg2044_gate_clock gate_clks[] = {
	{ GATE_CLK_AP_CPU_NORMAL_DIV0, "clk_gate_ap_cpu_normal_div0", "mpll0_clock",
	...
	{ GATE_CLK_CC_GRP_SYS_DIV0, "clk_gate_cc_grp_sys_div0", "mpll3_clock",
	...
	{ GATE_CLK_CXP_CFG, "clk_gate_cxp_cfg", "clk_div_top_axi0",
	...
	{ GATE_CLK_APB_ROM, "clk_gate_apb_rom", "clk_gate_top_axi0",
		CLK_IGNORE_UNUSED, 0x2004, 4, 0 },
	//TODO: no intc/mailbox clkgen register in execl, found in top misc
	#if 1
	{ GATE_CLK_MAILBOX0, "clk_gate_mailbox0", "clk_gate_top_axi0",
		CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x16, 5, 0 },
	{ GATE_CLK_MAILBOX0, "clk_gate_mailbox0", "clk_gate_top_axi0",
		CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x17, 5, 0 },
	{ GATE_CLK_MAILBOX0, "clk_gate_mailbox0", "clk_gate_top_axi0",
		CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x18, 5, 0 },
	{ GATE_CLK_MAILBOX0, "clk_gate_mailbox0", "clk_gate_top_axi0",
		CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x19, 5, 0 },
	...
	{ GATE_CLK_CXP_MAC_DIV0, "clk_gate_cxp_mac_div0", "fpll1",
		CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x2000, 14, 0 },

	{ GATE_CLK_CXP_TEST_ETH_PHY, "clk_gate_cxp_test_eth_phy", "fpll2",
		CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x2000, 7, 0 },
	{ GATE_CLK_DDR0_PLL_BYPASS, "clk_gate_ddr0_pll_bypass", "fpll2",
		CLK_IGNORE_UNUSED, 0x2000, 16, 0 },
	{ GATE_CLK_DDR1_PLL_BYPASS, "clk_gate_ddr1_pll_bypass", "fpll2",
		CLK_IGNORE_UNUSED, 0x2000, 17, 0 },
	{ GATE_CLK_DDR2_PLL_BYPASS, "clk_gate_ddr2_pll_bypass", "fpll2",
		CLK_IGNORE_UNUSED, 0x2000, 18, 0 },
	{ GATE_CLK_DDR3_PLL_BYPASS, "clk_gate_ddr3_pll_bypass", "fpll2",
		CLK_IGNORE_UNUSED, 0x2000, 19, 0 },
	{ GATE_CLK_DDR4_PLL_BYPASS, "clk_gate_ddr4_pll_bypass", "fpll2",
		CLK_IGNORE_UNUSED, 0x2000, 20, 0 },
	{ GATE_CLK_DDR5_PLL_BYPASS, "clk_gate_ddr5_pll_bypass", "fpll2",
		CLK_IGNORE_UNUSED, 0x2000, 21, 0 },
	{ GATE_CLK_DDR6_PLL_BYPASS, "clk_gate_ddr6_pll_bypass", "fpll2",
		CLK_IGNORE_UNUSED, 0x2000, 22, 0 },
	{ GATE_CLK_DDR7_PLL_BYPASS, "clk_gate_ddr7_pll_bypass", "fpll2",
		CLK_IGNORE_UNUSED, 0x2000, 23, 0 },
	{ GATE_CLK_DDR8_PLL_BYPASS, "clk_gate_ddr8_pll_bypass", "fpll2",
		CLK_IGNORE_UNUSED, 0x2000, 24, 0 },
	{ GATE_CLK_DDR9_PLL_BYPASS, "clk_gate_ddr9_pll_bypass", "fpll2",
		CLK_IGNORE_UNUSED, 0x2000, 25, 0 },
	{ GATE_CLK_DDR10_PLL_BYPASS, "clk_gate_ddr10_pll_bypass", "fpll2",
		CLK_IGNORE_UNUSED, 0x2000, 26, 0 },
	{ GATE_CLK_DDR11_PLL_BYPASS, "clk_gate_ddr11_pll_bypass", "fpll2",
		CLK_IGNORE_UNUSED, 0x2000, 27, 0 },
	{ GATE_CLK_DDR12_PLL_BYPASS, "clk_gate_ddr12_pll_bypass", "fpll2",
		CLK_IGNORE_UNUSED, 0x2000, 28, 0 },
	{ GATE_CLK_DDR13_PLL_BYPASS, "clk_gate_ddr13_pll_bypass", "fpll2",
		CLK_IGNORE_UNUSED, 0x2000, 29, 0 },
	{ GATE_CLK_DDR14_PLL_BYPASS, "clk_gate_ddr14_pll_bypass", "fpll2",
		CLK_IGNORE_UNUSED, 0x2000, 30, 0 },
	{ GATE_CLK_DDR15_PLL_BYPASS, "clk_gate_ddr15_pll_bypass", "fpll2",
		CLK_IGNORE_UNUSED, 0x2000, 31, 0 },

	{ GATE_CLK_DDR0_DIV0, "clk_gate_ddr0_div0", "dpll0_clock",
		CLK_IGNORE_UNUSED, 0x2008, 7, 0 },
	{ GATE_CLK_DDR1_DIV0, "clk_gate_ddr1_div0", "dpll1_clock",
		CLK_IGNORE_UNUSED, 0x2008, 8, 0 },
	{ GATE_CLK_DDR2_DIV0, "clk_gate_ddr2_div0", "dpll2_clock",
		CLK_IGNORE_UNUSED, 0x2008, 9, 0 },
	{ GATE_CLK_DDR3_DIV0, "clk_gate_ddr3_div0", "dpll3_clock",
		CLK_IGNORE_UNUSED, 0x2008, 10, 0 },
	{ GATE_CLK_DDR4_DIV0, "clk_gate_ddr4_div0", "dpll4_clock",
		CLK_IGNORE_UNUSED, 0x2008, 11, 0 },
	{ GATE_CLK_DDR5_DIV0, "clk_gate_ddr5_div0", "dpll5_clock",
		CLK_IGNORE_UNUSED, 0x2008, 12, 0 },
	{ GATE_CLK_DDR6_DIV0, "clk_gate_ddr6_div0", "dpll6_clock",
		CLK_IGNORE_UNUSED, 0x2008, 13, 0 },
	{ GATE_CLK_DDR7_DIV0, "clk_gate_ddr7_div0", "dpll7_clock",
		CLK_IGNORE_UNUSED, 0x2008, 14, 0 },
};
